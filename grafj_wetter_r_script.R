...
#' 
## ----map svg, eval=TRUE, echo=FALSE, message=FALSE, error=FALSE, warning=FALSE, fig.width = 12, fig.height = 8----
...
## ----Reformating date column, echo=TRUE, include=TRUE--------------------------------
...
## ----hist soil temp, echo=FALSE, include=TRUE, fig.width = 12, fig.height = 8--------
edx %>%
ggplot(aes(V_TE005M)) +
...
## ----Hist air temp mean, echo=FALSE, include=TRUE, fig.width = 12, fig.height = 8----
edx %>%
ggplot(aes(TMK)) +
geom_histogram(binwidth = 0.5, color = "grey") +
xlab("°C") +
...
## ----Hist air temp max, echo=FALSE, include=TRUE, fig.width = 12, fig.height = 8-----
edx %>%
ggplot(aes(TXK)) +
geom_histogram(binwidth = 0.5, color = "grey") +
xlab("°C") +
...
## ----Hist air temp min, echo=FALSE, include=TRUE, fig.width = 12, fig.height = 8-----
edx %>%
ggplot(aes(TNK)) +
geom_histogram(binwidth = 0.5, color = "grey") +
xlab("°C") +
...
## ----Hist VPM: counts by variable, echo=FALSE, include=TRUE, fig.width = 12, fig.height = 8----
edx %>%
ggplot(aes(VPM)) +
geom_histogram(binwidth = 0.5, color = "grey") +
xlab("hPa") +
...
## ----hist rel humidity, echo=FALSE, include=TRUE, fig.width = 12, fig.height = 8-----
edx %>%
ggplot(aes(UPM)) +
geom_histogram(binwidth = 0.5, color = "grey") +
xlab("%") +
...
## ----knn, echo=TRUE, include=TRUE, fig.width = 12, fig.height = 8--------------------
model_knn <- train(
...
#' \newpage
#' ### 1,000 trees  
## ----rf 1000, echo=TRUE, include=TRUE------------------------------------------------
model_rf_1000 <- train(
  V_TE005M ~ RSK + SDK + VPM + TMK + UPM + TXK + TNK + TGK + month_m,
  tuneLength = 1,
  data = edx, 
...
## ----final validation, echo=TRUE, include=TRUE---------------------------------------
